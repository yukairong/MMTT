...
# *********************************************************************************************************************
def build_mot_wildTrack(image_set: str, args):
    """
    ...
    # 检测路径的有效性
    assert root.exists(), f'provided MOT_wildTrack path {root} does not exist'
    ...
    dataset = MOT(
        ...
        prev_frame_range=args.prev_frame_range,
        return_masks=args.masks,
        overflow_boxes=args.overflow_boxes,
        remove_no_obj_imgs=False,
        prev_frame=args.tracking,
        prev_frame_rnd_augs=args.prev_frame_rnd_augs,
